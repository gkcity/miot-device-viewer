...
@Component({
  ...
  templateUrl: './device.instance.service.property.constraint.component.html',
  styleUrls: ['./device.instance.service.property.constraint.component.less'],
  standalone: true,
  imports: [
    NzButtonModule,
    NzInputModule,
  ...
  providers: [
    {
      ...
      useExisting: DeviceInstanceServicePropertyConstraintComponent,
      multi: true
    }
  ]
})
export class DeviceInstanceServicePropertyConstraintComponent implements ControlValueAccessor {
  ...
  // 组件内部维护的值
  _value: ConstraintType = ConstraintType.NONE;
