...
@Component({
  selector: 'device-instance-service-property-unit',
  templateUrl: './device.instance.service.property.unit.component.html',
  styleUrls: ['./device.instance.service.property.unit.component.less'],
  standalone: true,
  imports: [
    NzButtonModule,
    NzInputModule,
  ...
  providers: [
    {
      ...
      useExisting: DeviceInstanceServicePropertyUnitComponent,
      multi: true
    }
  ]
})
export class DeviceInstanceServicePropertyUnitComponent implements ControlValueAccessor {
