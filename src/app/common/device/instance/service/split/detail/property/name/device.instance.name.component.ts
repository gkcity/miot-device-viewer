...
@Component({
  selector: 'device-instance-name',
  templateUrl: './device.instance.name.component.html',
  styleUrls: ['./device.instance.name.component.less'],
  standalone: true,
  imports: [
    NzButtonModule,
    NzInputModule,
  ...
  providers: [
    {
      ...
      useExisting: DeviceInstanceNameComponent,
      multi: true
    }
  ]
})
export class DeviceInstanceNameComponent implements ControlValueAccessor {
